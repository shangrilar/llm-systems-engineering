...
export default {
  articleId:"collective-ring-tree",figureId:"01-step-1",number:"01-step-1",
  ...
  alt:["Ring: 조각을 전달하며 합산하기 — 전달 1단계. 전체 벡터에서 합산되는 위치를 강조합니다. 화살표는 보내는 조각입니다.","Ring: pass chunks and accumulate — Transfer step 1. The updated position is highlighted in each full vector. Arrows show sent chunks."],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:935,y:389,fill:C.ink,"font-size":23,"font-weight":700,"text-anchor":"middle"},"D: 4");
    p.el("path",{d:"M899,558 L758,635",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    p.el('text',{x:935,y:615,fill:C.ink,"font-size":23,"font-weight":700,"text-anchor":"middle"},"A: 10");
    p.el("path",{d:"M442,635 L301,558",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    p.el('text',{x:265,y:615,fill:C.ink,"font-size":23,"font-weight":700,"text-anchor":"middle"},"B: 200");
    p.el("path",{d:"M301,432 L442,355",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    p.el('text',{x:265,y:389,fill:C.ink,"font-size":23,"font-weight":700,"text-anchor":"middle"},"C: 3000");
    ...
    p.el('text',{x:632,y:346,fill:C.ink,"font-size":18,"font-weight":700,"text-anchor":"middle"},"3003");
    ...
    p.el('text',{x:600,y:373,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},"C: 3 + 3000 = 3003");
    ...
    p.el('text',{x:1030,y:515,fill:C.ink,"font-size":18,"font-weight":700,"text-anchor":"middle"},"44");
    p.el('text',{x:930,y:542,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},"D: 40 + 4 = 44");
    ...
    p.el('text',{x:496,y:684,fill:C.ink,"font-size":18,"font-weight":700,"text-anchor":"middle"},"110");
    ...
    p.el('text',{x:600,y:711,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},"A: 100 + 10 = 110");
    ...
    p.el('text',{x:234,y:515,fill:C.ink,"font-size":18,"font-weight":700,"text-anchor":"middle"},"2200");
    ...
    p.el('text',{x:270,y:542,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},"B: 2000 + 200 = 2200");
