...
We have examined TP as partitioning feature-wise computation for the same input, SP as partitioning activations between TP regions, and CP as partitioning a long context while preserving its attention relationships. Later, we will examine how pipeline parallelism (PP) moves beyond partitioning within a layer to placing different model layers on different GPUs.
