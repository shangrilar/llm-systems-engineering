...
export default {
  ...
  panels(locale:Locale){
    const p=new Panel(locale,null,1218,1104,[48,205]);
    ...
    p.el("path",{d:"M235,643 L307,571",fill:"none",stroke:C.slate,"stroke-width":1.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M600,643 L672,571",fill:"none",stroke:C.slate,"stroke-width":1.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M965,643 L1037,571",fill:"none",stroke:C.slate,"stroke-width":1.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M235,1067 L307,1139",fill:"none",stroke:C.slate,"stroke-width":1.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M600,1067 L672,1139",fill:"none",stroke:C.slate,"stroke-width":1.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M965,1067 L1037,1139",fill:"none",stroke:C.slate,"stroke-width":1.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("rect",{x:48,y:1345,width:1104,height:70,rx:14,fill:C.surface,stroke:C.line,"stroke-width":1.5});
