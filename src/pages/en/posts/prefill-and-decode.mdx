...
Executing multiple requests together is an important way to improve Decode efficiency. In practice, however, requests have different arrival times and context lengths, and GPU resources are limited. [Batching and Scheduling](/en/posts/batching-and-scheduling/) examines how to group these requests and decide what to include in the next execution.
