...
export default {
  articleId:"collective-ring-tree",figureId:"03-step-3",number:"03-step-3",
  ...
  alt:["Tree: 모아서 더하고 다시 펼치기 — 3단계 · GPU 0에서 GPU 2로 배포. 화살표: 배열 전체 전달 · 상자: 전달 후의 값","Tree: reduce, then broadcast — Step 3 · broadcast from GPU 0 to GPU 2. Arrows: whole-array transfers · Boxes: values after transfer"],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:48,y:234,fill:C.ink,"font-size":28,"font-weight":700,"text-anchor":"start"},["3단계 · GPU 0에서 GPU 2로 배포","Step 3 · broadcast from GPU 0 to GPU 2"]);
    ...
    p.el("path",{d:"M750,370 L870,424",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    ...
    p.el('text',{x:80,y:626,fill:C.muted,"font-size":23,"font-weight":400,"text-anchor":"start"},"0 → 2");
    p.el('text',{x:80,y:658.2,fill:C.muted,"font-size":23,"font-weight":400,"text-anchor":"start"},["완성된 배열을 복사","Copy the completed array"]);
    return [p];
  },
