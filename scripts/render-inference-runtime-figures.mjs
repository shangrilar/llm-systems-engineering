// Generate SVGs with generate-inference-runtime-figures.py, then run this renderer.
...
const figs=JSON.parse(await fs.readFile(repo+'/scripts/inference-runtime-figures.json','utf8'));
