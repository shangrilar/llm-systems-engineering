...
export default {
  ...
  panels(locale:Locale){
    const p=new Panel(locale,null,1287,1104,[48,205]);
    ...
    p.el("path",{d:"M600,302 L600,338",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M600,444 L600,478",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("rect",{x:48,y:557,width:1104,height:780,rx:14,fill:C.surface,stroke:C.line,"stroke-width":1.5});
    ...
    p.el("path",{d:"M250,681 L250,720",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M250,1017 L250,1060",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M600,681 L600,720",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M600,1017 L600,1060",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M950,681 L950,720",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M950,1017 L950,1060",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    ...
    p.el("path",{d:"M600,1205 L600,1238",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    p.el('text',{x:600,y:1282,fill:C.blue,"font-size":27,"font-weight":600,"text-anchor":"middle"},["Head 1 출력 O1 · 3 × 4","Head 1 output O1 · 3 × 4"]);
    p.el("path",{d:"M600,1352 L600,1390",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.slate)});
    p.el("rect",{x:85,y:1408,width:1030,height:76,rx:14,fill:C.surface,stroke:C.line,"stroke-width":1.5});
