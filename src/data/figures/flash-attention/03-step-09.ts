...
export default {
  articleId:"flash-attention",figureId:"03-step-09",number:"03-step-09",
  ...
  alt:["왼쪽 Q 두 행, 위쪽 K 네 벡터, 아래쪽 V 네 벡터, 오른쪽 출력 누적 벡터를 배치한다. K와 V는 토큰을 가로로 나열한 전치 배치다. 중앙에는 현재 2×2 타일의 점수 또는 정규화 전 exp 값만 표시한다. Q와 출력 위치를 고정하고 두 K/V 타일을 순회한다. 중앙의 전체 격자는 처리 위치 지도이며 전체 점수 행렬을 저장하지 않는다. 스케일링과 마스크를 생략한 교육용 계산이다. 현재 단계: 마지막 · 지수합으로 나누기","Two Q rows on the left, four K vectors above, four V vectors below, and output accumulator vectors on the right. K and V are transposed to arrange tokens horizontally. The center shows only the current 2×2 tile of scores or unnormalized exponentials. Q and output positions stay fixed while traversing two K/V tiles. The full grid maps processing positions and does not store the full score matrix. This educational example omits scaling and masking. Current step: Finish · Divide by the exponential sum."],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:76,y:233,fill:C.blue,"font-size":27,"font-weight":700,"text-anchor":"start"},["9 / 9    마지막 · 지수합으로 나누기","9 / 9    Finish · Divide by the exponential sum"]);
    p.el('text',{x:76,y:269,fill:C.ink,"font-size":22,"font-weight":400,"text-anchor":"start"},["각 행의 a를 같은 행의 최종 ℓ로 나누어 출력 O를 완성합니다.","Divide each row’s a by its final ℓ to complete output O."]);
    ...
    p.el('text',{x:1036,y:549,fill:C.teal,"font-size":24,"font-weight":700,"text-anchor":"middle"},["최종 출력 O","Final output O"]);
    p.el('text',{x:550,y:549,fill:C.teal,"font-size":24,"font-weight":700,"text-anchor":"middle"},["처리 완료","Complete"]);
    ...
    p.el('text',{x:608,y:617,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},["소비됨","Consumed"]);
    ...
    p.el('text',{x:728,y:617,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},["소비됨","Consumed"]);
    p.el("rect",{x:940,y:582,width:91,height:54,rx:12,fill:C.tealFill,stroke:C.line,"stroke-width":1.5});
    p.el('text',{x:985.5,y:617,fill:C.teal,"font-size":22,"font-weight":600,"text-anchor":"middle"},"0.341");
    p.el("rect",{x:1034,y:582,width:91,height:54,rx:12,fill:C.tealFill,stroke:C.line,"stroke-width":1.5});
    p.el('text',{x:1079.5,y:617,fill:C.teal,"font-size":22,"font-weight":600,"text-anchor":"middle"},"1.659");
    ...
    p.el('text',{x:608,y:721,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},["소비됨","Consumed"]);
    ...
    p.el('text',{x:728,y:721,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},["소비됨","Consumed"]);
    p.el("rect",{x:940,y:686,width:91,height:54,rx:12,fill:C.tealFill,stroke:C.line,"stroke-width":1.5});
    p.el('text',{x:985.5,y:721,fill:C.teal,"font-size":22,"font-weight":600,"text-anchor":"middle"},"1.266");
    p.el("rect",{x:1034,y:686,width:91,height:54,rx:12,fill:C.tealFill,stroke:C.line,"stroke-width":1.5});
    p.el('text',{x:1079.5,y:721,fill:C.teal,"font-size":22,"font-weight":600,"text-anchor":"middle"},"0.734");
    ...
    p.el('text',{x:1036,y:807,fill:C.teal,"font-size":20,"font-weight":600,"text-anchor":"middle"},"O = a ÷ ℓ");
    ...
    p.el('text',{x:77,y:1098,fill:C.ink,"font-size":25,"font-weight":400,"text-anchor":"start"},"Q₀: O₀ = a₀ ÷ ℓ₀ ≈ [0.341, 1.659]");
    p.el('text',{x:77,y:1145,fill:C.ink,"font-size":25,"font-weight":400,"text-anchor":"start"},"Q₁: O₁ = a₁ ÷ ℓ₁ ≈ [1.266, 0.734]");
