...
Initially, we processed the given input context together. Later, we processed one new input while reading past KV. In [Prefill and Decode](/en/posts/prefill-and-decode/), we will name these two executions and examine how the number of tokens computed together and the length of the attended context affect computation and memory reads.
