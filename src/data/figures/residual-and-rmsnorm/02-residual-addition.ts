...
export default {
  ...
  panels(locale:Locale){
    const p=new Panel(locale,null,787,1104,[48,206]);
    ...
    p.el("path",{d:"M420,424 H930 V461",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.muted)});
    p.el("circle",{cx:420,cy:424,r:5,fill:C.blue});
    p.el("rect",{x:770,y:474,width:320,height:125,rx:14,fill:C.grayFill,stroke:C.line,"stroke-width":1.5});
    ...
    p.el("path",{d:"M930,599 L930,635",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.muted)});
    ...
    p.el("path",{d:"M930,760 V802 H455",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.muted)});
