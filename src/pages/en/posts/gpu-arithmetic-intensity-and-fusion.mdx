...
In the [previous article](https://llm-systems-engineering.pages.dev/en/posts/cpu-gpu-work-execution/), we followed how the CPU requests GPU work and how streams and events connect execution order and completion. Before that, we examined how threads, blocks, and warps execute inside the GPU. Does creating enough parallel work let us fully use a GPU's compute capacity?
