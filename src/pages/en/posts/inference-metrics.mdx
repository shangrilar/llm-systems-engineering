...
<figure class="article-figure">
  ...
  <figcaption>Figure 1. Different starting and ending points on the same request produce different latency metrics.</figcaption>
</figure>
...
<figure class="article-figure">
  ...
  <figcaption>Figure 2. Divide completed requests and output tokens across requests by the same observation time.</figcaption>
</figure>
...
<figure class="article-figure">
  ...
  <figcaption>Figure 3. Even with the same TPOT, individual token intervals can reveal a long pause during generation.</figcaption>
</figure>
...
<figure class="article-figure">
  ...
  <figcaption>Figure 4. Sorting request latencies distinguishes the majority of requests from those that waited longer.</figcaption>
</figure>
...
<figure class="article-figure">
  ...
  <figcaption>Figure 5. Calculate goodput by counting only completed requests that meet every latency target.</figcaption>
</figure>
