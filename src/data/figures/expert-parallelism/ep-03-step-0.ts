...
export default {
  articleId:"expert-parallelism",figureId:"ep-03-step-0",number:"ep-03-step-0",
  layout:'wide',screens:['desktop'],
  eyebrow:["그림 3","Figure 3"],
  title:["여러 Expert의 결과도 같은 토큰으로 돌아오기","Return multiple expert results to the same token"],
  subtitle:["A2의 Router: E0 0.7, E2 0.3 선택","A2 router: choose E0 0.7 and E2 0.3"],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:180,y:817,fill:C.muted,"font-size":19,"font-weight":400,"text-anchor":"middle"},["A2가 선택한 Expert","Selected for A2"]);
    p.el('text',{x:804,y:817,fill:C.muted,"font-size":19,"font-weight":400,"text-anchor":"middle"},["A2가 선택한 Expert","Selected for A2"]);
