...
export default {
  articleId:"expert-parallelism",figureId:"ep-02-step-2",number:"ep-02-step-2",
  layout:'wide',screens:['desktop'],
  eyebrow:["그림 2","Figure 2"],
  title:["토큰을 Expert로 보내고 원래 위치로 돌려받기","Send tokens to experts and return their results"],
  subtitle:["Dispatch: Expert별로 토큰 모으기","Dispatch: group tokens by expert"],
  alt:["E2에는 A2와 B2가 함께 모입니다. Expert 가중치는 GPU에 그대로 있습니다.","E2 receives A2 and B2 together. Expert weights stay on their GPUs."],
  ...
  panels(locale:Locale){
    ...
    p.el("path",{d:"M180,516 L180,699",fill:"none",stroke:C.blue,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el("path",{d:"M396,516 L396,550 L780,550 L780,699",fill:"none",stroke:C.teal,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el("path",{d:"M804,516 L804,602 L420,602 L420,699",fill:"none",stroke:C.purple,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el("path",{d:"M1020,516 L1020,651 L844,651 L844,699",fill:"none",stroke:C.orange,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el("rect",{x:98,y:766,width:164,height:44,rx:10,fill:C.blueFill,stroke:C.blue,"stroke-width":1.5});
    p.el('text',{x:180,y:795,fill:C.blue,"font-size":22,"font-weight":700,"text-anchor":"middle"},"A1");
    p.el("rect",{x:722,y:766,width:164,height:44,rx:10,fill:C.tealFill,stroke:C.teal,"stroke-width":1.5});
    p.el('text',{x:804,y:795,fill:C.teal,"font-size":22,"font-weight":700,"text-anchor":"middle"},"A2");
    p.el("rect",{x:314,y:766,width:164,height:44,rx:10,fill:C.purpleFill,stroke:C.purple,"stroke-width":1.5});
    p.el('text',{x:396,y:795,fill:C.purple,"font-size":22,"font-weight":700,"text-anchor":"middle"},"B1");
    p.el("rect",{x:722,y:824,width:164,height:44,rx:10,fill:C.orangeFill,stroke:C.orange,"stroke-width":1.5});
    p.el('text',{x:804,y:853,fill:C.orange,"font-size":22,"font-weight":700,"text-anchor":"middle"},"B2");
    ...
    p.el('text',{x:600,y:1354,fill:C.ink,"font-size":22,"font-weight":700,"text-anchor":"middle"},["E2에는 A2와 B2가 함께 모입니다. Expert 가중치는 GPU에 그대로 있습니다.","E2 receives A2 and B2 together. Expert weights stay on their GPUs."]);
