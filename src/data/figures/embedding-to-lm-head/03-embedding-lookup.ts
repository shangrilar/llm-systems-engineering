...
export default {
  ...
  panels(locale:Locale){
    ...
    p.el("rect",{x:410,y:438,width:248,height:54,rx:0,fill:C.paper,stroke:C.line,"stroke-width":1});
    ...
    p.el("rect",{x:410,y:546,width:248,height:54,rx:0,fill:C.paper,stroke:C.line,"stroke-width":1});
    ...
    p.el("rect",{x:410,y:654,width:248,height:54,rx:0,fill:C.paper,stroke:C.line,"stroke-width":1});
