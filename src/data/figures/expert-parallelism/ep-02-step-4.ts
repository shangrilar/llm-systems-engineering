...
export default {
  articleId:"expert-parallelism",figureId:"ep-02-step-4",number:"ep-02-step-4",
  layout:'wide',screens:['desktop'],
  eyebrow:["그림 2","Figure 2"],
  title:["토큰을 Expert로 보내고 원래 위치로 돌려받기","Send tokens to experts and return their results"],
  subtitle:["회수: 결과를 출발 GPU로","Return: send results to the source GPU"],
  alt:["원격 결과는 GPU 경계를 다시 건너고, 로컬 결과는 같은 GPU에 남습니다.","Remote results cross GPU boundaries again; local results stay on their GPU."],
  ...
  panels(locale:Locale){
    ...
    p.el("path",{d:"M180,944 L180,1050",fill:"none",stroke:C.blue,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el("path",{d:"M780,944 L780,981 L396,981 L396,1050",fill:"none",stroke:C.teal,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el("path",{d:"M420,944 L420,1012 L804,1012 L804,1050",fill:"none",stroke:C.purple,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el("path",{d:"M844,944 L844,1036 L1020,1036 L1020,1050",fill:"none",stroke:C.orange,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    ...
    p.el('text',{x:600,y:1354,fill:C.ink,"font-size":22,"font-weight":700,"text-anchor":"middle"},["원격 결과는 GPU 경계를 다시 건너고, 로컬 결과는 같은 GPU에 남습니다.","Remote results cross GPU boundaries again; local results stay on their GPU."]);
