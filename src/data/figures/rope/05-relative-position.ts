...
export default {
  ...
  panels(locale:Locale){
    ...
    p.el("rect",{x:58,y:305,width:516,height:624,rx:14,fill:C.surface,stroke:C.line,"stroke-width":1.5});
    ...
    p.el("path",{d:"M381.0,573.0 A65,65 0 0 0 332.82323793166387,510.21482129121057",fill:"none",stroke:C.slate,"stroke-width":2,"marker-end":markerUrl(C.slate)});
    ...
    p.el("rect",{x:626,y:305,width:516,height:624,rx:14,fill:C.surface,stroke:C.line,"stroke-width":1.5});
    ...
    p.el("path",{d:"M940.2916512459885,540.5 A65,65 0 0 0 867.1767620683362,510.21482129121057",fill:"none",stroke:C.slate,"stroke-width":2,"marker-end":markerUrl(C.slate)});
