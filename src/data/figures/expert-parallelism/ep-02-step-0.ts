...
export default {
  articleId:"expert-parallelism",figureId:"ep-02-step-0",number:"ep-02-step-0",
  layout:'wide',screens:['desktop'],
  eyebrow:["그림 2","Figure 2"],
  title:["토큰을 Expert로 보내고 원래 위치로 돌려받기","Send tokens to experts and return their results"],
  subtitle:["입력: 각 GPU의 두 토큰","Input: two tokens on each GPU"],
  alt:["A와 B는 서로 다른 시퀀스입니다. 한 칸은 토큰 하나의 활성값 벡터입니다.","A and B are different sequences. Each chip is one token activation vector."],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:600,y:1354,fill:C.ink,"font-size":22,"font-weight":700,"text-anchor":"middle"},["A와 B는 서로 다른 시퀀스입니다. 한 칸은 토큰 하나의 활성값 벡터입니다.","A and B are different sequences. Each chip is one token activation vector."]);
