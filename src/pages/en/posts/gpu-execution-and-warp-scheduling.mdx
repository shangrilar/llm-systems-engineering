...
In the [next article](https://llm-systems-engineering.pages.dev/en/posts/cpu-gpu-work-execution/), we will widen our view to the whole program and follow how the CPU requests GPU work and uses its results. We will prepare space for inputs and results and connect the execution order between operations with streams and events.
