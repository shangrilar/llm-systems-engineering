...
export default {
  articleId:"expert-parallelism",figureId:"ep-02-step-1",number:"ep-02-step-1",
  layout:'wide',screens:['desktop'],
  eyebrow:["그림 2","Figure 2"],
  title:["토큰을 Expert로 보내고 원래 위치로 돌려받기","Send tokens to experts and return their results"],
  subtitle:["Router: 토큰마다 Expert 선택","Router: select one expert per token"],
  alt:["Router는 목적지를 고릅니다. Expert에 보내는 것은 토큰의 입력 벡터입니다.","The router selects destinations. Experts receive token input vectors."],
  ...
  panels(locale:Locale){
    ...
    p.el("path",{d:"M288,362 L288,390",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    ...
    p.el("path",{d:"M912,362 L912,390",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    ...
    p.el('text',{x:600,y:1354,fill:C.ink,"font-size":22,"font-weight":700,"text-anchor":"middle"},["Router는 목적지를 고릅니다. Expert에 보내는 것은 토큰의 입력 벡터입니다.","The router selects destinations. Experts receive token input vectors."]);
