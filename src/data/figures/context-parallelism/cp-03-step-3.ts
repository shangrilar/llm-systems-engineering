...
export default {
  articleId:"context-parallelism",figureId:"cp-03-step-3",number:"cp-03-step-3",
  ...
  alt:["단계 4. GPU 0은 Q(t0,t1)을 유지하며 KV0, KV3, KV2, KV1 블록의 기여를 정규화 통계와 함께 누적한다.","Step 4. GPU 0 keeps Q(t0,t1) and accumulates contributions from KV0, KV3, KV2, KV1 with normalization statistics."],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:608,y:228,"font-size":20,fill:C.ink,"font-weight":700,"text-anchor":"middle"},"K1");
    p.el("rect",{x:582,y:243,width:26,height:26,fill:C.orangeFill,stroke:C.orange,"stroke-width":1});
    p.el("rect",{x:608,y:243,width:26,height:26,fill:C.orangeFill,stroke:C.orange,"stroke-width":1});
    p.el("rect",{x:582,y:269,width:26,height:26,fill:C.orangeFill,stroke:C.orange,"stroke-width":1});
    p.el("rect",{x:608,y:269,width:26,height:26,fill:C.orangeFill,stroke:C.orange,"stroke-width":1});
    p.el('text',{x:704,y:228,"font-size":20,fill:C.ink,"font-weight":700,"text-anchor":"middle"},"V1");
    p.el("rect",{x:678,y:243,width:26,height:26,fill:C.orangeFill,stroke:C.orange,"stroke-width":1});
    p.el("rect",{x:704,y:243,width:26,height:26,fill:C.orangeFill,stroke:C.orange,"stroke-width":1});
    p.el("rect",{x:678,y:269,width:26,height:26,fill:C.orangeFill,stroke:C.orange,"stroke-width":1});
    p.el("rect",{x:704,y:269,width:26,height:26,fill:C.orangeFill,stroke:C.orange,"stroke-width":1});
    p.el('text',{x:600,y:331,"font-size":18,fill:C.muted,"font-weight":400,"text-anchor":"middle"},"Q: t0·t1   KV: t2·t3");
    ...
    p.el('text',{x:993,y:483,"font-size":20,fill:C.ink,"font-weight":700,"text-anchor":"middle"},"K2");
    p.el("rect",{x:967,y:498,width:26,height:26,fill:C.tealFill,stroke:C.teal,"stroke-width":1});
    p.el("rect",{x:993,y:498,width:26,height:26,fill:C.tealFill,stroke:C.teal,"stroke-width":1});
    p.el("rect",{x:967,y:524,width:26,height:26,fill:C.tealFill,stroke:C.teal,"stroke-width":1});
    p.el("rect",{x:993,y:524,width:26,height:26,fill:C.tealFill,stroke:C.teal,"stroke-width":1});
    p.el('text',{x:1089,y:483,"font-size":20,fill:C.ink,"font-weight":700,"text-anchor":"middle"},"V2");
    p.el("rect",{x:1063,y:498,width:26,height:26,fill:C.tealFill,stroke:C.teal,"stroke-width":1});
    p.el("rect",{x:1089,y:498,width:26,height:26,fill:C.tealFill,stroke:C.teal,"stroke-width":1});
    p.el("rect",{x:1063,y:524,width:26,height:26,fill:C.tealFill,stroke:C.teal,"stroke-width":1});
    p.el("rect",{x:1089,y:524,width:26,height:26,fill:C.tealFill,stroke:C.teal,"stroke-width":1});
    p.el('text',{x:985,y:586,"font-size":18,fill:C.muted,"font-weight":400,"text-anchor":"middle"},"Q: t2·t3   KV: t4·t5");
    ...
    p.el('text',{x:608,y:744,"font-size":20,fill:C.ink,"font-weight":700,"text-anchor":"middle"},"K3");
    p.el("rect",{x:582,y:759,width:26,height:26,fill:C.purpleFill,stroke:C.purple,"stroke-width":1});
    p.el("rect",{x:608,y:759,width:26,height:26,fill:C.purpleFill,stroke:C.purple,"stroke-width":1});
    p.el("rect",{x:582,y:785,width:26,height:26,fill:C.purpleFill,stroke:C.purple,"stroke-width":1});
    p.el("rect",{x:608,y:785,width:26,height:26,fill:C.purpleFill,stroke:C.purple,"stroke-width":1});
    p.el('text',{x:704,y:744,"font-size":20,fill:C.ink,"font-weight":700,"text-anchor":"middle"},"V3");
    p.el("rect",{x:678,y:759,width:26,height:26,fill:C.purpleFill,stroke:C.purple,"stroke-width":1});
    p.el("rect",{x:704,y:759,width:26,height:26,fill:C.purpleFill,stroke:C.purple,"stroke-width":1});
    p.el("rect",{x:678,y:785,width:26,height:26,fill:C.purpleFill,stroke:C.purple,"stroke-width":1});
    p.el("rect",{x:704,y:785,width:26,height:26,fill:C.purpleFill,stroke:C.purple,"stroke-width":1});
    p.el('text',{x:600,y:847,"font-size":18,fill:C.muted,"font-weight":400,"text-anchor":"middle"},"Q: t4·t5   KV: t6·t7");
    ...
    p.el('text',{x:223,y:483,"font-size":20,fill:C.ink,"font-weight":700,"text-anchor":"middle"},"K0");
    p.el("rect",{x:197,y:498,width:26,height:26,fill:C.blueFill,stroke:C.blue,"stroke-width":1});
    p.el("rect",{x:223,y:498,width:26,height:26,fill:C.blueFill,stroke:C.blue,"stroke-width":1});
    p.el("rect",{x:197,y:524,width:26,height:26,fill:C.blueFill,stroke:C.blue,"stroke-width":1});
    p.el("rect",{x:223,y:524,width:26,height:26,fill:C.blueFill,stroke:C.blue,"stroke-width":1});
    p.el('text',{x:319,y:483,"font-size":20,fill:C.ink,"font-weight":700,"text-anchor":"middle"},"V0");
    p.el("rect",{x:293,y:498,width:26,height:26,fill:C.blueFill,stroke:C.blue,"stroke-width":1});
    p.el("rect",{x:319,y:498,width:26,height:26,fill:C.blueFill,stroke:C.blue,"stroke-width":1});
    p.el("rect",{x:293,y:524,width:26,height:26,fill:C.blueFill,stroke:C.blue,"stroke-width":1});
    p.el("rect",{x:319,y:524,width:26,height:26,fill:C.blueFill,stroke:C.blue,"stroke-width":1});
    p.el('text',{x:215,y:586,"font-size":18,fill:C.muted,"font-weight":400,"text-anchor":"middle"},"Q: t6·t7   KV: t0·t1");
    ...
    p.el('text',{x:600,y:550,"font-size":20,fill:C.purple,"font-weight":700,"text-anchor":"middle"},["4 / 4 블록 계산","4 / 4 blocks processed"]);
    ...
    p.el("rect",{x:224,y:1022,width:122,height:94,rx:0,fill:"none",stroke:C.ink,"stroke-width":3});
