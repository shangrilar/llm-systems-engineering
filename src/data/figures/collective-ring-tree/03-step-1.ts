...
export default {
  articleId:"collective-ring-tree",figureId:"03-step-1",number:"03-step-1",
  ...
  alt:["Tree: 모아서 더하고 다시 펼치기 — 1단계 · 아래에서 두 곳으로 합산. 화살표: 배열 전체 전달 · 상자: 전달 후의 값","Tree: reduce, then broadcast — Step 1 · reduce in two places. Arrows: whole-array transfers · Boxes: values after transfer"],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:48,y:234,fill:C.ink,"font-size":28,"font-weight":700,"text-anchor":"start"},["1단계 · 아래에서 두 곳으로 합산","Step 1 · reduce in two places"]);
    ...
    p.el("path",{d:"M330,424 L450,370",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    p.el("path",{d:"M910,591 L910,548",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    ...
    p.el('text',{x:600,y:334,fill:C.ink,"font-size":21,"font-weight":700,"text-anchor":"middle"},"[11, 22, 33, 44]");
    ...
    p.el('text',{x:910,y:507,fill:C.ink,"font-size":21,"font-weight":700,"text-anchor":"middle"},"[1100, 2200, 3300, 4400]");
    ...
    p.el('text',{x:80,y:626,fill:C.muted,"font-size":23,"font-weight":400,"text-anchor":"start"},"1 → 0, 3 → 2");
    p.el('text',{x:80,y:658.2,fill:C.muted,"font-size":23,"font-weight":400,"text-anchor":"start"},["두 전달과 합산을 동시에","Both transfers reduce in parallel"]);
    return [p];
  },
