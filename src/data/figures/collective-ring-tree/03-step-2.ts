...
export default {
  articleId:"collective-ring-tree",figureId:"03-step-2",number:"03-step-2",
  ...
  alt:["Tree: 모아서 더하고 다시 펼치기 — 2단계 · GPU 0에 전체 합 완성. 화살표: 배열 전체 전달 · 상자: 전달 후의 값","Tree: reduce, then broadcast — Step 2 · complete the sum on GPU 0. Arrows: whole-array transfers · Boxes: values after transfer"],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:48,y:234,fill:C.ink,"font-size":28,"font-weight":700,"text-anchor":"start"},["2단계 · GPU 0에 전체 합 완성","Step 2 · complete the sum on GPU 0"]);
    ...
    p.el("path",{d:"M870,424 L750,370",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    ...
    p.el('text',{x:80,y:626,fill:C.muted,"font-size":23,"font-weight":400,"text-anchor":"start"},"2 → 0");
    p.el('text',{x:80,y:658.2,fill:C.muted,"font-size":23,"font-weight":400,"text-anchor":"start"},["부분합끼리 더하기","Add the two partial sums"]);
    return [p];
  },
