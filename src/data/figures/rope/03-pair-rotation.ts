...
export default {
  ...
  panels(locale:Locale){
    const p=new Panel(locale,null,959,1104,[48,206]);
    ...
    p.el("path",{d:"M880,536 L990,426",fill:"none",stroke:C.slate,"stroke-width":2,"marker-end":markerUrl(C.muted)});
    ...
    p.el("path",{d:"M552,536 L648,536",fill:"none",stroke:C.slate,"stroke-width":2.5,"marker-end":markerUrl(C.muted)});
