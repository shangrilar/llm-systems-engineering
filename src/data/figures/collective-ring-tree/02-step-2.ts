...
export default {
  articleId:"collective-ring-tree",figureId:"02-step-2",number:"02-step-2",
  ...
  alt:["Ring: 완성된 조각을 모두에게 — 전달 2단계. 받은 결과로 빈 위치를 채웁니다. 화살표는 보내는 조각입니다.","Ring: distribute the completed chunks — Transfer step 2. Fill missing positions with received results. Arrows show sent chunks."],
  ...
  panels(locale:Locale){
    ...
    p.el('text',{x:935,y:389,fill:C.ink,"font-size":23,"font-weight":700,"text-anchor":"middle"},"D");
    p.el("path",{d:"M899,558 L758,635",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    p.el('text',{x:935,y:615,fill:C.ink,"font-size":23,"font-weight":700,"text-anchor":"middle"},"A");
    p.el("path",{d:"M442,635 L301,558",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    p.el('text',{x:265,y:615,fill:C.ink,"font-size":23,"font-weight":700,"text-anchor":"middle"},"B");
    p.el("path",{d:"M301,432 L442,355",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
    p.el('text',{x:265,y:389,fill:C.ink,"font-size":23,"font-weight":700,"text-anchor":"middle"},"C");
    ...
    p.el("rect",{x:600,y:325,width:64,height:30,rx:10,fill:"white",stroke:C.blue,"stroke-width":1.5});
    p.el("rect",{x:600,y:325,width:64,height:30,rx:8,fill:"none",stroke:C.blue,"stroke-width":3});
    p.el('text',{x:632,y:346,fill:C.ink,"font-size":18,"font-weight":700,"text-anchor":"middle"},"3333");
    ...
    p.el('text',{x:600,y:373,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},["새로 받은 값: C = 3333","Received: C = 3333"]);
    ...
    p.el("rect",{x:998,y:494,width:64,height:30,rx:10,fill:"white",stroke:C.teal,"stroke-width":1.5});
    p.el("rect",{x:998,y:494,width:64,height:30,rx:8,fill:"none",stroke:C.teal,"stroke-width":3});
    p.el('text',{x:1030,y:515,fill:C.ink,"font-size":18,"font-weight":700,"text-anchor":"middle"},"4444");
    p.el('text',{x:930,y:542,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},["새로 받은 값: D = 4444","Received: D = 4444"]);
    ...
    p.el("rect",{x:464,y:663,width:64,height:30,rx:10,fill:"white",stroke:C.purple,"stroke-width":1.5});
    p.el("rect",{x:464,y:663,width:64,height:30,rx:8,fill:"none",stroke:C.purple,"stroke-width":3});
    p.el('text',{x:496,y:684,fill:C.ink,"font-size":18,"font-weight":700,"text-anchor":"middle"},"1111");
    ...
    p.el('text',{x:600,y:711,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},["새로 받은 값: A = 1111","Received: A = 1111"]);
    ...
    p.el("rect",{x:202,y:494,width:64,height:30,rx:10,fill:"white",stroke:C.orange,"stroke-width":1.5});
    p.el("rect",{x:202,y:494,width:64,height:30,rx:8,fill:"none",stroke:C.orange,"stroke-width":3});
    p.el('text',{x:234,y:515,fill:C.ink,"font-size":18,"font-weight":700,"text-anchor":"middle"},"2222");
    ...
    p.el('text',{x:270,y:542,fill:C.muted,"font-size":18,"font-weight":400,"text-anchor":"middle"},["새로 받은 값: B = 2222","Received: B = 2222"]);
