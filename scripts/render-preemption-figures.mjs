// Generate SVGs with generate-preemption-figures.py, then run this renderer.
...
const figs=JSON.parse(await fs.readFile(repo+'/scripts/preemption-figures.json','utf8'));
