...
export default {
  articleId:"expert-parallelism",figureId:"ep-03-step-4",number:"ep-03-step-4",
  layout:'wide',screens:['desktop'],
  eyebrow:["그림 3","Figure 3"],
  title:["여러 Expert의 결과도 같은 토큰으로 돌아오기","Return multiple expert results to the same token"],
  subtitle:["Router 가중치로 합쳐 A2의 출력 완성","Weight and combine to produce the A2 output"],
  ...
  panels(locale:Locale){
    ...
    p.el("rect",{x:87,y:770,width:186,height:44,rx:10,fill:C.tealFill,stroke:C.teal,"stroke-width":1.5});
    p.el('text',{x:180,y:799,fill:C.teal,"font-size":22,"font-weight":700,"text-anchor":"middle"},"u0 = E0(A2)");
    p.el("rect",{x:711,y:770,width:186,height:44,rx:10,fill:C.tealFill,stroke:C.teal,"stroke-width":1.5});
    p.el('text',{x:804,y:799,fill:C.teal,"font-size":22,"font-weight":700,"text-anchor":"middle"},"u2 = E2(A2)");
    p.el("path",{d:"M180,910 L180,1090",fill:"none",stroke:C.teal,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el("path",{d:"M804,910 L804,977 L396,977 L396,1090",fill:"none",stroke:C.teal,"stroke-width":3,"marker-end":markerUrl(C.muted)});
    p.el('text',{x:804,y:1034,fill:C.muted,"font-size":22,"font-weight":400,"text-anchor":"middle"},["u2를 GPU0으로 반환","Return u2 to GPU0"]);
    ...
    p.el('text',{x:288,y:1212,fill:C.ink,"font-size":24,"font-weight":700,"text-anchor":"middle"},"y(A2) = 0.7 × u0 + 0.3 × u2");
    p.el("rect",{x:201,y:1270,width:174,height:44,rx:10,fill:C.tealFill,stroke:C.teal,"stroke-width":1.5});
    p.el('text',{x:288,y:1299,fill:C.teal,"font-size":22,"font-weight":700,"text-anchor":"middle"},"y(A2)");
    p.el("path",{d:"M288,1242 L288,1263",stroke:C.muted,"stroke-width":2.5,fill:"none","marker-end":markerUrl(C.muted)});
